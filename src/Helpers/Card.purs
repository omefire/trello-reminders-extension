module Helpers.Card (getCardIdFromUrl, getFirstElementByClassName, nextSibling, URL, alert, getElementById, showDialog, documentHead, setOnLoad,
                     JQuery, JQueryDialog, jqry, dialog, showModal, show, setTimeout, setInterval, flatpickr, getElementsByClassName) where
...
getElememntsByClassName className doc = do
  eltsCollection <- DOM.getElementsByClassName className doc
  pure $ toArray eltsCollection
